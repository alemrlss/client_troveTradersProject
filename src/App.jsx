...
import { HOME, LOGIN, POST, PROFILE, REGISTER, TRADE, EMAILVERIFICATION, CREARPRODUCTO, LANDING, ANTIGUEDADES, MUSICA, CARTAS, TECNOLOGIA, COMICS, JUGUETES, DEPORTE, LIBROS, OTROS, FORGOT, RESULTADO} from "./routes/paths";
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/" element={<PrivateRoute />}>
              ...
              <Route path={`${EMAILVERIFICATION}/:token/test`} element={<EmailVerification/>} />
