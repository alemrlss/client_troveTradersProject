...
function antiguedadesComponent({ posts, user }) {
  ...
  //Filtro
  const cartasPosts = dataPosts.filter((post) => post.category === "cartas");
  ...
  const currentPosts = cartasPosts.slice(indexOfFirstPost, indexOfLastPost);

  const totalPages = Math.ceil(cartasPosts.length / postsPerPage);
