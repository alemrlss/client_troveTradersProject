                    ...
                    <ul
                        ...
                        <li className="flex items-center py-3">
                            ...
                            <span className="ml-auto"><span
                                    className="bg-red-500 py-1 px-2 rounded text-white text-sm">USUARIO NO VERIFICADO</span></span>
                        </li>
                        <li className="flex items-center py-3">
                            {/*PONER A FUNCIONAR ESTO O BORRARLO */}
                ...
                <div className="bg-white p-3 shadow-sm rounded-sm">
                    ...
                    <div className="text-gray-700">
                        <div className="grid md:grid-cols-2 text-sm">
                            ...
                            <div className="grid grid-cols-2">
                                <div className="px-4 py-2 font-semibold">Numero Telefonico:</div>
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                <div className="px-4 py-2">
                                    <a className="text-blue-800" href="mailto:jane@example.com">kevin@ejemplo.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
